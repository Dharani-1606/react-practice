...
const ElevationDemo = () => {
  ...
  let analysis: ElevationProfileAnalysis | null = null;
  useEffect(() => {

    // Dark gray basemap layer (your URL)
    const baseLayer = new TileLayer({
      url: "https://services.arcgisonline.com/arcgis/rest/services/Canvas/World_Dark_Gray_Base/MapServer"
    });

    // ----- Static polygon data (simulating block groups) -----
    const sampleData = [
    ...
    // ----- Class Break Renderer -----
    // ----- FeatureLayer from client-side graphics -----
    ...
    // console.log("log elevLyr :>>", elevLyr);
